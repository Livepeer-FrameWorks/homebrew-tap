class FrameworksCli < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "eea6c4cddd379caa864c5682dec2341d79a2dfa04aed1dccdc1c49d9971c2148"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "0dc3a1fabf5abbef7424ef2d8dc8cf4b8cbbd49f5213568c373a8c6f6fd58096"
    end
    on_intel do
      ...
      sha256 "ff3efcb4bd39b014aaef668373f1c4bb21ff054b6e0db36e659c5e12a6991fdb"
    end
  end
