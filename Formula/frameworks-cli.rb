class FrameworksCli < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "7239bf2d1ca30cd3e9737b32059bfae43359a35aa09d5c445e0dcab979c3cbb7"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "c9e65d7590f52e0b3504bbf291524fda25732909bd9be44478945ec30a9b0a6a"
    end
    on_intel do
      ...
      sha256 "727de6abf543fab0c0c5b50078902b2097e5aebdaa7b90939480891948cd058e"
    end
  end
