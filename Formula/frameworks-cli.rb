class FrameworksCli < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "75bc3de4d0adb39a7f54e0cf9afb917c81a41dfaa3e019481f81b2a24da4df5b"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "d1cf40f03472eb225543535d29bdb73de0ff70c234d7b82fcd25bf99edde3729"
    end
    on_intel do
      ...
      sha256 "3f3f878aad8312b78607c2c654de5d05967ce3d6b3b35509d9ca2e14120199cf"
    end
  end
